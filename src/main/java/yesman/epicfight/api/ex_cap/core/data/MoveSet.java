        ...
        public static MoveSetBuilder deserialize(JsonElement jsonObject) throws JsonParseException
        {
            ...
            try {
                if (jsonObject.isJsonObject())
                {
                    ...
                    if (json.has("guard_holds"))
                    {
                        ...
                        if (get.isJsonObject())
                        {
                            get.getAsJsonObject().entrySet().forEach(entry -> {
                                Skill guard = SkillManager.getSkill(String.valueOf(ResourceLocation.parse(entry.getKey())));
                    ...
                    {
                        result.addInnateSkill((itemStack, playerPatch) -> SkillManager.getSkill(String.valueOf(ResourceLocation.parse(json.get("innate_skill").getAsString()))));
                    }
                    ...
                    {
                        result.setPassiveSkill(SkillManager.getSkill(String.valueOf(ResourceLocation.parse(json.get("weapon_passive").getAsString()))));
                    }
