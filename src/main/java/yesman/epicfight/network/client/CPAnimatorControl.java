...
public class CPAnimatorControl extends AnimatorControlPacket {
	...
	public static CPAnimatorControl fromBytes(FriendlyByteBuf buf) {
		return new CPAnimatorControl(buf.readEnum(Action.class), EpicFightByteBufs.readSignedVarInt(buf), buf.readFloat(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean());
	}
